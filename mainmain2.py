...
def QR_code_decoding():
    img1 = cv2.imread(r"C:\users\subhash\OneDrive\Pictures\Saved Pictures\th.jpg")
...
def decryption(decoded_matrix,L1,P1,U,L,P,principle_components):
    # Second lu inverse
    lu_inverse = np.dot(np.dot(P1,decoded_matrix),L1)
    print(lu_inverse)
